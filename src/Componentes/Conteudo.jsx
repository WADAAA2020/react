    ...
    return (
        <main className={estilo.container}>
            ...
            <section className={estilo.resumo}>
                <p>"A Liga dos Ruivos" a história começa com Watson chegando na casa de Sherlock Holmes. Holmes estava visitando o Sr. Jabez Wilson. Wilson é um joalheiro que conta algo que esta acontecendo sem saber se é algo criminoso aconteceu ou não, ele está sendo enganado pelo seu assistente John Clay, mas Clay é um membro da "A Liga dos cabeças-vermelhas", será que Holmes vai conseguir parar o assalto antes de ser concluído.</p>
            </section>
        </main>
    )
}